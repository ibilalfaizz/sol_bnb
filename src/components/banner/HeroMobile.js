    ...
    <div className='w-[full]'>
        ...
        <div className='w-full relative flex justify-end pr-4'>
            ...
            <motion.div 
                ...
                >
                <motion.img src={image1} width={80}
                    initial="hidden"
                    animate="visible"
                    variants={img1y}
                    transition={{
            ...
            <motion.div 
                ...
                >
                <motion.img src={image2} width={60}
                    initial="hidden"
                    animate="visible"
                    variants={img2y}
                    transition={{
            ...
            <motion.div 
                ...
                >
                <motion.img src={image3} width={40}
                    initial="hidden"
                    animate="visible"
                    variants={img3y}
                    transition={{
        ...
        <div className='w-[95%] mx-auto h-full overflow-hidden mt-5'>
            ...
            >
                ...
                <div className='w-full flex justify-between px-4'>
                    <div className='flex gap-2 items-center px-2 py-1 rounded-full cursor-pointer' onClick={()=>{setPay("ETH"); setPayIcon(eth)}} style={{backgroundColor : `${pay}` === "ETH" ? ("#000000") : (""), color : `${pay}` === "ETH" ? ("#ffffff") : ("")}}>
                        <img src={eth} width={25}/>
                        <span>ETH</span>
                    </div>

                    <div className='flex gap-2 items-center px-2 py-1 rounded-full cursor-pointer' onClick={()=>{setPay("BSC"); setPayIcon(bsc)}} style={{backgroundColor : `${pay}` === "BSC" ? ("#000000") : (""), color : `${pay}` === "BSC" ? ("#ffffff") : ("")}}>
                        <img src={bsc} width={25} />
                        <span>BSC</span>
                    </div>

                    <div className='flex gap-2 items-center px-2 py-1 rounded-full cursor-pointer' onClick={()=>{setPay("SOL"); setPayIcon(sol)}} style={{backgroundColor : `${pay}` === "SOL" ? ("#000000") : (""), color : `${pay}` === "SOL" ? ("#ffffff") : ("")}}>
                ...
                <div className='w-full flex justify-between border-[1.5px] border-black py-2 px-4 rounded-full'>
                    ...
                    <div className='flex gap-2 items-center px-2 py-1 rounded-full cursor-pointer' onClick={()=>{setRecieve("BSC"); setRecieveIcon(bsc)}} style={{backgroundColor : `${recieve}` === "BSC" ? ("#FD395C") : ('')}}>
                        <img src={bsc} width={25} />
                        <span>BSC</span>
                    </div>

                    <div className='flex gap-2 items-center px-2 py-1 rounded-full cursor-pointer' onClick={()=>{setRecieve("SOL"); setRecieveIcon(sol)}} style={{backgroundColor : `${recieve}` === "SOL" ? ("#FD395C") : ("")}}>
                        <img src={sol} width={25}/>
                        <span>SQL</span>
                    </div>
                </div>
                ...
                <div className='w-full flex gap-2'>
                    ...
                    <div className='w-1/2 flex flex-col gap-1'>
                        ...
                        <div className='flex border-[1.5px] border-black rounded-full'>
                            <div type='number' placeholder='0' className='w-[80%] bg-transparent pl-3 text-[#6A6A6A] outline-none'>{value}</div>
