...
function Navbar() {
  ...
  const [hideNavbar , openNavbar] = useState('hidden')  
    ...
    <div className="navbar w-[100%] border-b">
     ...
     <div className="logo-icon  flex items-center justify-between">
        ...
        <div className="block xl:hidden lg:hidden">
          <button className="border-0 flex items-center" onClick={()=> openNavbar('block')}>
      ...
      <div className="navs ">
        <ul className={`${hideNavbar} h-[100vh] lg:h-auto text-center lg:text-start xl:flex lg:flex xl:justify-center gap-8`}>
